...
public class Article {
	...
	public String toString() {
		return "Article [id=" + id + ", title=" + title + ", content=" + content + ", picture=" + picture
				...
				+ ", updated=" + updated + ", conmmentCnt=" + conmmentCnt + "]";
	}
	...
	public Integer getConmmentCnt() {
		return conmmentCnt;
	}
	public void setConmmentCnt(Integer conmmentCnt) {
		this.conmmentCnt = conmmentCnt;
	}
